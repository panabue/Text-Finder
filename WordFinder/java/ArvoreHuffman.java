...
public class ArvoreHuffman {
  ...
  public ArvoreHuffman(String input) {
  ...
  private Map<Character, Integer> calculateFrequencies(String input) {
    ...
    for (int i = 0; i < input.length(); i++) {
      ...
      // Frequência desse caracter na tabela de frequências (0 é padrão para
      // caracteres ainda não inseridos)
  ...
  private void buildTrie(Map<Character, Integer> frequencies) {
    // Fila de prioridades que vai armazenar os nós que precisam ser adicionados à
    // nossa Trie.
  ...
  private void generateHuffmanCodes(TrieNode node, String code) {
    ...
    // Se o nó for folha, ele adiciona o nó na tabela de símbolos do Huffman com a
  ...
  public String decompress(String compressed) { // 00110101
    ...
    // símbolo binário atual. Se for zero, vai para a esquerda. Se for um, vai pela
    // direita.
